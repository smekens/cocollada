...
collada_instance_node_t *collada_instance_node_parser(collada_ctx_t *ctx, yaxp_node_t *node0)
{
	collada_instance_node_t *result = collada_ctx_factory(ctx, collada_instance_node_t);
...
void collada_instance_node_dump(collada_ctx_t *ctx, collada_instance_node_t *instance_node, int indent)
{
